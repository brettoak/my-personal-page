    ...
    <section id="contact" className="contact-section py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <AnimatedCard>
            <a href="https://www.google.com/maps/place/Melbourne+VIC/@-37.8136276,144.9630576,10z" target="_blank" rel="noopener noreferrer">
              <div className="contact-item text-center cursor-pointer">
                <div className="skill-icon text-accent mx-auto mb-4">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
